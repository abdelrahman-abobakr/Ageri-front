        ...
        <div className="p-6">
          ...
          <div className="flex gap-3 justify-end">
            ...
            <button
              ...
              className={`px-6 py-2 text-white rounded-lg transition-colors flex items-center gap-2 ${action === 'approve'
                  ...
                  <div className="flex items-center justify-center gap-2">
                    ...
                    {publication.status === 'published' && (
                      <button
                        ...
                        className={`inline-flex items-center gap-1 px-3 py-1.5 text-xs font-medium rounded-lg transition-colors ${publication.is_featured
